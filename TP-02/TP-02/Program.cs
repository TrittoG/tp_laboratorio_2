...
namespace TP_02_2018
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Nombre del alumno
            Console.Title = "Giuliano Tritto 2 'C'";
            ...
            Snacks s1 = new Snacks(Producto.EMarca.Pepsico, "asdasd", ConsoleColor.Black);

            // Agrego 8 ítems (los últimos 2 no deberían poder agregarse ni el m2 repetido) y muestro
            changoDeCompras += c1;
            changoDeCompras += c2;
            changoDeCompras += m1;
            changoDeCompras += m1;
